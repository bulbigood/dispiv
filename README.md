...
```
---
pipeline_id: DISPIV-2026-001
spec_ref: NARRATOR-SPEC-v2.2
dag:
  - id: task_1
    file: task-1.md
    target: src/java/contract/Contracts.java
    depends_on: []
  - id: task_2
    file: task-2.md
    target: src/java/contract/ContractManager.java
    depends_on: [task_1]
---
# Описание плана
Этот пайплайн реализует миграцию REST API на единый WebSocket контракт...
```
